<template>
    <div>
        <TransitionRoot appear :show="getIsShowKradetails" as="template">
                            ...
                            <DialogPanel
                                ...
                                <DialogTitle as="h3" class="text-base pb-2 font-medium leading-6 primaryColor">
                                    <div>
                                        ...
                                        <JsonViewer class="!text-xs" :value="xmlValue" />
                                    </div>
                                </DialogTitle>
                            </DialogPanel>
                        </TransitionChild>
...
export default {
    ...
    props: {
        xmlValue: { required: true }
    },
    methods: {
        closeDialog() {
            this.$store.commit('approval/setIsShowKradetails', false)
        },
        ...
        copyResponseBody() {
            ...
            navigator.clipboard.writeText(JSON.stringify(this.xmlValue));
    ...
    unmounted() {
        this.$store.commit('approval/setXmlValue', '')
    },
};
</script>
