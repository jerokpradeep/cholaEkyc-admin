<template>
  <div class="p-5 max-w-[1000px] h-[calc(100vh-160px)] overflow-y-auto">
    <ul role="list" class="space-y-6 max-w-[1000px]">
      <li v-for="(activityItem, activityItemIdx) in activity" :key="activityItem.id" class="relative flex gap-x-4">
        ...
        <template v-else>
          ...
          <p class="flex-auto py-0.5 text-xs leading-5 text-gray-500">
            <span class="font-medium text-gray-900">{{ activityItem.person.name }}</span> {{ activityItem.type }} at
          </p>
          <time :datetime="activityItem.dateTime" class="flex-none py-0.5 text-xs leading-5 text-gray-500">{{ activityItem.date }}</time>
        </template>
      </li>
    ...
    <!-- New comment form -->
    <div class="mt-6 flex gap-x-3 max-w-[1000px]">
      ...
      <form class="relative flex-auto">
        <div class="overflow-hidden rounded-lg pb-12 shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-indigo-600">
          ...
          <textarea rows="2" name="comment" id="comment" class="px-2 block w-full resize-none border-0 bg-transparent py-1.5 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="Add your comment..." />
        </div>
...
export default {
  components: { CheckCircleIcon,FaceFrownIcon, FaceSmileIcon, FireIcon, HandThumbUpIcon, HeartIcon, PaperClipIcon, XMarkIcon,
    Listbox, ListboxButton, ListboxLabel, ListboxOption, ListboxOptions },
  data() {
    return {
      activity: [
        { id: 1, type: 'Mobile OTP Verified', person: { name: 'Chelsea Hagon' }, date: '7d ago', dateTime: '2023-01-23T10:32' },
        { id: 2, type: 'EMail OTP Verified', person: { name: 'Chelsea Hagon' }, date: '6d ago', dateTime: '2023-01-23T11:03' },
        { id: 3, type: 'Password Setup Completed', person: { name: 'Chelsea Hagon' }, date: '6d ago', dateTime: '2023-01-23T11:24' },
        {
          id: 4,
          type: 'commented',
          person: {
        ...
        { id: 5, type: 'PAN Entered', person: { name: 'Chelsea Hagon' }, date: '2d ago', dateTime: '2023-01-24T09:12' },
        { id: 6, type: 'PAN name Check', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
        { id: 8, type: 'PAN Confirmed', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
        { id: 9, type: 'KRA DOB Completed', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
        { id: 10, type: 'AADHAR Entry', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
        { id: 11, type: 'Profile Completed', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
        { id: 12, type: 'Bank Entry Completed', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
        { id: 13, type: 'Penny Drop Successfull', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
        { id: 14, type: 'Segment Selection Completed', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
        { id: 15, type: 'Payment Completed', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
        { id: 16, type: 'Nominee 1 Completed', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
        { id: 17, type: 'Nominee 2 Completed', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
        { id: 18, type: 'Nominee 3 Completed', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
        { id: 19, type: 'Nominee Allocation Completed', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
        { id: 20, type: 'Document Upload', person: { name: 'Chelsea Hagon' }, date: '1d ago', dateTime: '2023-01-24T09:20' },
      ],
      moods: [
