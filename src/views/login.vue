        ...
        <div class="bg-white rounded-lg p-8 w-[400px] mx-auto">
            ...
            <form @submit.prevent="handleSubmit()" class="flex flex-col gap-4 justify-center items-center w-[320px] mx-auto">
                <div>
                    ...
                    <div class="relative ">
                        <input v-model="emailId" type="text" id="login_email" maxlength="50" class="bg-gray-100 text-sm py-2 px-4 h-8 rounded-lg min-w-[320px]" placeholder="jane@example.com" required="" autofocus="" autocomplete="username">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input v-model="password" type="password" id="login_password" maxlength="50" class="bg-gray-100 text-sm py-2 px-4 h-8 rounded-lg min-w-[320px]" placeholder="•••••" autocomplete="current-password" required="">
