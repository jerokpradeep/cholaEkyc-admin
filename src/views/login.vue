        ...
        <div class="bg-white rounded-lg p-8 w-[400px] mx-auto">
            ...
            <form @submit.prevent="handleSubmit()" class="flex flex-col gap-4 justify-center items-center w-[320px] mx-auto">
                <div>
                    ...
                    <div class="relative ">
                        <input v-model="emailId" type="text" id="login_email" maxlength="50" class="bg-gray-100 min-h-[35px] text-sm py-2 indent-5 h-8 rounded-lg min-w-[320px]" placeholder="jane@example.com" autofocus="" autocomplete="username">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input v-model="password" :type="isPassType" id="login_password" maxlength="50" class="bg-gray-100 min-h-[35px] text-sm py-2 indent-5 px-5 h-8 rounded-lg min-w-[320px]" placeholder="•••••" autocomplete="current-password">
                        <svg class="absolute top-2 left-2" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="absolute top-2 cursor-pointer right-2 text-[#74808B] text-xs select-none" v-if="isPassType == 'password'" @click="isPassType = 'text'">Show</div>
                        <div class="absolute top-2 cursor-pointer right-2 text-[#74808B] text-xs select-none" v-else @click="isPassType = 'password'">Hide</div>
                    </div>
                </div> 
