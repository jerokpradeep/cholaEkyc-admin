const state = {
    kycApprovalTabs : [
        { name: 'Details', id: 0, active: true, count: '0' , remarks: []},
        ...
        'PAN image uploaded is not legible, please upload clear / visible PAN image']},
        { name: 'Address', id: 2, active: false, count: '0', remarks: ['Client name mismatch between Aadhar and Pan','Please mask first 8 digit aadhar number and upload aadhar image','Address proof image uploaded is not legible, please upload clear / visible address proof image','Please upload clear aadhar card-front & back side image with address and other details','Address entered is not matching with Address proof'] },
        { name: 'Profile', id: 3, active: false, count: '0', remarks:[]},
